...
#import "HUD.h"
@interface EnSocietyViewController ()
{
...
@implementation EnSocietyViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSMutableArray *narrData2 = [objParser2 getDataFromParserWithPath:urlString2];
            NSMutableArray *nobjService2;
            DataBaseManger *dbMng1 = [[DataBaseManger alloc]init];
            
            if(narrData2.count>0)
            {
                BOOL isDone=[dbMng1 ndeleteSelectedService2 :(DataBO *)nobjService2];
            ...
            if(narrData2.count>0)
            {
                BOOL isDone=[dbMng1 naddServiceToDataBase2:narrData2];
                if(isDone)
                {

...
#import "HUD.h"
@interface EnBlogViewController ()
{
...
@implementation EnBlogViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSString *urlString8 = @"http://www.infotradetechapp.com/Setopati/setopatiapi.php?action=audio/video_en";
            ...
            NSMutableArray *narrData8 = [objParser8 getDataFromParserWithPath:urlString8];
            NSMutableArray *nobjService8;
            DataBaseManger *dbMng8 = [[DataBaseManger alloc]init];
            
            if(narrData8.count>0)
            {
                BOOL isDone=[dbMng8 ndeleteSelectedService8 :(DataBO *)nobjService8];
            ...
            if(narrData8.count>0)
            {
                BOOL isDone=[dbMng8 naddServiceToDataBase8:narrData8];
                if(isDone)
                {

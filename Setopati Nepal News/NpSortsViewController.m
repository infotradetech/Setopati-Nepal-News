...
#import "HUD.h"
@interface NpSortsViewController ()
{
...
@implementation NpSortsViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
  ...
  /*  [[NSNotificationCenter defaultCenter ]addObserver:self
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            NSString *urlString5 = @"http://www.infotradetechapp.com/Setopati/setopatiapi.php?action=special_np";

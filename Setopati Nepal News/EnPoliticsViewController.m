...
#import "HUD.h"
@interface EnPoliticsViewController ()
{
...
@implementation EnPoliticsViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSMutableArray *narrData1 = [objParser1 getDataFromParserWithPath:urlString1];
            NSMutableArray *nobjService1;
            DataBaseManger *dbMng1 = [[DataBaseManger alloc]init];
            
            if(narrData1.count>0)
            {
                BOOL isDone=[dbMng1 ndeleteSelectedService1 :(DataBO *)nobjService1];
            ...
            if(narrData1.count>0)
            {
                BOOL isDone=[dbMng1 naddServiceToDataBase1:narrData1];
                if(isDone)
                {

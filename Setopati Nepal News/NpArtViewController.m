...
@implementation NpArtViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
   ...
   /* [[NSNotificationCenter defaultCenter ]addObserver:self
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
                        NSString *urlString4 = @"http://www.infotradetechapp.com/Setopati/setopatiapi.php?action=sports_np";

...
#import "HUD.h"
@interface EnSportsViewController ()
{
...
@implementation EnSportsViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSMutableArray *narrData5 = [objParser5 getDataFromParserWithPath:urlString5];
            NSMutableArray *nobjService5;
            DataBaseManger *dbMng5 = [[DataBaseManger alloc]init];
            
            if(narrData5.count>0)
            {
                BOOL isDone=[dbMng5 ndeleteSelectedService5 :(DataBO *)nobjService5];
            ...
            if(narrData5.count>0)
            {
                BOOL isDone=[dbMng5 naddServiceToDataBase5:narrData5];
                if(isDone)
                {

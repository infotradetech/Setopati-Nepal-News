...
#import "HUD.h"
@interface EnSpecialViewController ()
{
...
@implementation EnSpecialViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSMutableArray *narrData6 = [objParser6 getDataFromParserWithPath:urlString6];
            NSMutableArray *nobjService6;
            DataBaseManger *dbMng6 = [[DataBaseManger alloc]init];
            
            if(narrData6.count>0)
            {
                BOOL isDone=[dbMng6 ndeleteSelectedService6 :(DataBO *)nobjService6];
            ...
            if(narrData6.count>0)
            {
                BOOL isDone=[dbMng6 naddServiceToDataBase6:narrData6];
                if(isDone)
                {

...
#import "HUD.h"
@interface NpPoliticsViewController ()
{
    //NSData *data;
...
@end
@implementation NpPoliticsViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSString *urlString1 = @"http://www.infotradetechapp.com/Setopati/setopatiapi.php?action=society_np";

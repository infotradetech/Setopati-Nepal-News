...
#import "HUD.h"
@interface EnOpinionViewController ()
{
...
@implementation EnOpinionViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSMutableArray *narrData7 = [objParser7 getDataFromParserWithPath:urlString7];
            NSMutableArray *nobjService7;
            DataBaseManger *dbMng7 = [[DataBaseManger alloc]init];
            
            if(narrData7.count>0)
            {
                BOOL isDone=[dbMng7 ndeleteSelectedService7 :(DataBO *)nobjService7];
            ...
            if(narrData7.count>0)
            {
                BOOL isDone=[dbMng7 naddServiceToDataBase7:narrData7];
                if(isDone)
                {

...
@implementation EnArtViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSMutableArray *narrData4 = [objParser4 getDataFromParserWithPath:urlString4];
            NSMutableArray *nobjService4;
            DataBaseManger *dbMng4 = [[DataBaseManger alloc]init];
            
            if(narrData4.count>0)
            {
                BOOL isDone=[dbMng4 ndeleteSelectedService4 :(DataBO *)nobjService4];
            ...
            if(narrData4.count>0)
            {
                BOOL isDone=[dbMng4 naddServiceToDataBase4:narrData4];
                if(isDone)
                {

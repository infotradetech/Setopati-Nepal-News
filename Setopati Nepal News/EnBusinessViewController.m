...
#import "HUD.h"
@interface EnBusinessViewController ()
{
...
@implementation EnBusinessViewController
@synthesize tbl1;
@synthesize tbl2;
@synthesize stdObj;
...
- (void)viewDidLoad
{
    ...
    reach.reachableBlock = ^(Reachability * reachability)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSMutableArray *narrData3 = [objParser3 getDataFromParserWithPath:urlString3];
            NSMutableArray *nobjService3;
            DataBaseManger *dbMng3 = [[DataBaseManger alloc]init];
            
            if(narrData3.count>0)
            {
                BOOL isDone=[dbMng3 ndeleteSelectedService3 :(DataBO *)nobjService3];
            ...
            if(narrData3.count>0)
            {
                BOOL isDone=[dbMng3 naddServiceToDataBase3:narrData3];
                if(isDone)
                {
